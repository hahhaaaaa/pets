...
module.exports.addService = async function ({
    name,
    img,
    species,
    photoWall1,
...
module.exports.upDateService = async function ([{
    name, //服务类别
    img, //图片路径
    photoWall1,
    photoWall2,
...
module.exports.delOneSer = async function ({
    _id
}) {
    return await ServiceModel.deleteOne({
        _id
    })
}